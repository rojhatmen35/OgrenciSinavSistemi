...
public class SinavEkrani extends javax.swing.JFrame implements IDuzenleyici {
    ...
    private void initComponents() {
        ...
        sinavEkraniPaneli.add(baslatButon, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 560, 100, 50));

        labelTime.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        labelTime.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        sinavEkraniPaneli.add(labelTime, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 40, 210, 70));
